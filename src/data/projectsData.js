...
export const projectsData = [
    {
        id: 1,
        projectName: 'PT. Mostrans Global Digilog, Jakarta, Indonesia',
        projectDesc: `  - As a backend engineer, I specialize in using Node.js, GraphQL, PostgreSQL, .NET, and Python. \n
        - Responsibilities include serving as the Project in Charge (PIC) for Logistics Quality Assurance, from January 2022 to present. \n
        - Responsibilities include serving as the Project in Charge (PIC) for Fleet Management, from June 2022 to present. \n
        - Responsibilities include serving as the Project in Charge (PIC) for Cross-Border projects, from December 2023 to present.`,
        tags: ['NodeJS', 'GraphQL' ,'PostgreSQL', '.Net', 'Python'],
        code: 'https://mostrans.co.id',
        demo: 'https://mostrans.co.id',
